...
def analyze(config):
    ...
    loop += ssdilep.algs.algs.PlotAlg(
            region       = 'CR2EEMUMUDeltaMass_TTTT',
            plot_all     = False,
            do_var_check = True,
            hist_list    = hist_list,
            cut_flow     = [
    ...
    loop += ssdilep.algs.algs.PlotAlg(
            region       = 'SR2EEMUMUDeltaMass_TTTT',
            plot_all     = False,
            do_var_check = True,
            hist_list    = hist_list,
            cut_flow     = [
