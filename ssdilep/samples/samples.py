...
diboson_alt = Sample( name =   'diboson_alt',
                  tlatex = 'DB inclusive',
...
ttbar_dilep = Sample( name =  'ttbar_dilep',
                    tlatex = 't#bar{t}',
                    fill_color = ROOT.kBlue-10,
                    line_color =  ROOT.kBlue-8,
                    marker_color =  ROOT.kBlue-8,
...
DCH_name =  'Pythia8EvtGen_A14NNPDF23LO_DCH%d'
DCH_tlatex = 'DCH%d'
DCH_masses = [
    200,
    250,
